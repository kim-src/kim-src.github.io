...
>    - 추상 자료구조 : Array, List, Stack, Queue, HashMap, HashTable, Set, Graph, Tree

### 📌 자료구조 : 선형 or 비선형
> - 선형 및 비선형 잣대의 자료구조는 아래와 같이 구분됩니다.
>    - 선형 자료구조 : ArrayList, LinkedList, Stack, Queue
>    - 비선형 자료구조 : HashMap, HashTable, Graph, Binary Search Tree
...
### 🔔 맵(HashMap)
### 📌 HashMap 특징
> - HashMap은 데이터가 key 및 value 쌍으로 구성되는 해시 구조로 구성됩니다.
