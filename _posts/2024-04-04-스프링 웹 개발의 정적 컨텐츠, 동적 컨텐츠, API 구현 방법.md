...
> -  메서드를 이용하여 <a href="https://github.com/Kim-src/Study-Spring/blob/main/src/main/java/hello/hellospring/controller/HelloController.java">컨트롤러</a>에 직접적으로 객체를 생성하였고 실행하였습니다.
