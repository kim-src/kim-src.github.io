...
<!-- 2024-04-08 글 작성 시작; 2024-99-99 페이지 호출 완료 -->
...
### 🔔 회원 관리를 위한 객체 생성
### 📌 Member 객체
> - 회원 관리를 위해 요구사항의 데이터(id, name) 관련 <a href="">회원 객체</a>를 생성하였습니다.
> - 각 데이터를 다른 객체에서 관리하기 위해 getter & setter 메서드를 생성하였습니다.

### 📌 MemberRepository 인터페이스
> - 데이터 저장소와 상호작용시킬 목적으로 인터페이스 역할의 <a href="">MemberRepository</a>를 생성하였습니다.
> - 그런데 아직 데이터 저장소가 선정되지 않은 상태에기 때문에 임시 목적의 저장소가 필요합니다.
> - 그래서 '임시 저장소' 역할을 하는 <a href="">MemoryMemberRepository</a>를 생성하였습니다.
